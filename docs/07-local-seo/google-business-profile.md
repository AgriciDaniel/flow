...
![Three uplift dimensions when every Google Business Profile field is filled — 2.7x more reputable, 70% more visits, 50% more purchase consideration](../../assets/diagrams/flow-v5-gbp-completeness.gif)

## What This Is

A Google Business Profile is the public business record that supports discovery, trust, and
local action. Treat it as an operating asset, not a set-and-forget listing.
