...
![Where ChatGPT pulls local-business information from — business websites 58%, mentions 27%, directories 15%; 45% of consumers use AI for local recommendations, 75% search with keywords not natural language, 39% click through to a business website](../../assets/diagrams/flow-v5-local-ai-source-mix.gif)

## What This Is

A local audit checks whether a business can be found, understood, trusted, and contacted
across website, profile, citations, search results, and AI surfaces.
